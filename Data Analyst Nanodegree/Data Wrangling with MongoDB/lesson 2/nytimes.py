...
def article_overview(kind, period):
    ...
    titles = [] # list of section:title dictionaries for each article
    urls =[] # list of "media" [] -> "media-metadata" [] -> "URL" if "format" == "Standard Thumbnail"
    # YOUR CODE HERE
    for piece in data:
        ...
        for meta in piece['media']:
            for source in meta["media-metadata"]:
              if source['format'] == 'Standard Thumbnail':
